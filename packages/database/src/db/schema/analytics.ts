...
// Relations
export const userAnalyticsEventsRelations = relations(
  userAnalyticsEvents,
  ({ one }) => ({
...
export const userContentInteractionsRelations = relations(
...
export const learningOutcomesRelations = relations(
  learningOutcomes,
  ({ one }) => ({
    user: one(userProfiles, {
...
export const performanceReportsRelations = relations(
  performanceReports,
  ({ one }) => ({
    user: one(userProfiles, {
...
export type UserContentInteraction =
  typeof userContentInteractions.$inferSelect;
export type NewUserContentInteraction =
