 ...
 */
export async function getOrganizationById(organizationId, context) {
 ...
 */
export async function getOrganizationBySlug(slug, context) {
 ...
 */
export async function searchOrganizations(searchTerm, context, options = {}) {
    const { limit = 20, offset = 0, organizationType, sizeCategory, status = 'active', } = options;
    const conditions = [
 ...
 */
export async function getOrganizationsByUser(userId, context, options = {}) {
 ...
 */
export async function getOrganizationStats(organizationId, context) {
    ...
    const [memberStats, subscriptionStats] = await Promise.all([
        ...
        db
            ...
            pendingInvitations: count(sql `CASE WHEN ${organizationMemberships.status} = 'pending' THEN 1 END`),
        })
 ...
 */
export async function getOrganizationMembers(organizationId, context, options = {}) {
 ...
 */
export async function getOrganizationBilling(organizationId, context) {
    const org = await getOrganizationById(organizationId, context);
    if (!org)
        return null;
 ...
 */
export async function createOrganization(organizationData, context) {
    const result = await db
 ...
 */
export async function updateOrganization(organizationId, updates, context) {
 ...
 */
export async function deleteOrganization(organizationId, context) {
 ...
 */
export async function getOrganizationMembershipById(membershipId, context) {
    const result = await db
        .select()
        .from(organizationMemberships)
 ...
 */
export async function getUserOrganizationMembership(userId, organizationId, context) {
    const result = await db
        .select()
        .from(organizationMemberships)
 ...
 */
export async function createOrganizationMembership(membershipData, context) {
    const result = await db
 ...
 */
export async function updateOrganizationMembership(membershipId, updates, context) {
    const result = await db
 ...
 */
export async function deleteOrganizationMembership(membershipId, context) {
    const result = await db
 ...
 */
export async function inviteUserToOrganization(organizationId, userEmail, role, context) {
    ...
    const existingMembership = await getUserOrganizationMembership(user[0].id, organizationId, context);
 ...
 */
export async function acceptOrganizationInvitation(membershipId, context) {
    ...
    return updateOrganizationMembership(membershipId, {
        status: 'active',
        joinedAt: new Date(),
    }, context);
}
 ...
 */
export async function rejectOrganizationInvitation(membershipId, context) {
    const membership = await getOrganizationMembershipById(membershipId, context);
    if (!membership) {
        throw new Error('Membership not found');
    }
