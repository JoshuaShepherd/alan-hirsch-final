 ...
 */
export async function explainGetUserByEmail() {
    const query = `
 ...
 */
export async function explainGetPublishedContent() {
    const query = `
 ...
 */
export async function explainGetUserAssessments() {
    const query = `
 ...
 */
export async function explainGetOrganizationMembers() {
    const query = `
 ...
 */
export async function explainSearchContent() {
    const query = `
 ...
 */
export async function explainGetCommunityPosts() {
    const query = `
 ...
 */
export async function explainGetUserSubscription() {
    const query = `
 ...
 */
export async function explainGetContentByCategory() {
    const query = `
 ...
 */
export async function explainGetTrendingContent() {
    const query = `
 ...
 */
export async function explainGetUserAnalytics() {
    const query = `
 ...
 */
export async function getQueryOptimizations() {
    return [
        {
            originalQuery: `
      ...
      `,
            performanceGain: 40,
            explanation: 'Added visibility filter and author details in single query to reduce N+1 queries',
        },
        {
            originalQuery: `
        SELECT * FROM user_profiles
      ...
      `,
            performanceGain: 25,
            explanation: 'Added account_status filter and LIMIT to reduce result set and improve performance',
        },
        {
            originalQuery: `
      ...
      `,
            performanceGain: 300,
            explanation: 'Replaced ILIKE with full-text search using PostgreSQL tsvector for much better performance',
        },
    ];
}
// ============================================================================
 ...
 */
export async function getTopQueriesPerformance() {
    const queries = [
        {
...
export async function generatePerformanceReport() {
    return {
        summary: 'Performance analysis shows 5 critical queries that need optimization, with potential for 75% overall improvement.',
        topIssues: [
