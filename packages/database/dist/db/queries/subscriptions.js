 ...
 */
export async function getSubscriptionPlanById(planId, context) {
 ...
 */
export async function getSubscriptionPlanBySlug(slug, context) {
    const result = await db
        .select()
        .from(subscriptionPlans)
        .where(and(eq(subscriptionPlans.slug, slug), eq(subscriptionPlans.isActive, true)))
        .limit(1);
    return hasResults(result) ? result[0] : null;
}
/**
 ...
 */
export async function getActiveSubscriptionPlans(context, options = {}) {
 ...
 */
export async function getPopularSubscriptionPlans(context, limit = 3) {
    return db
        .select()
        .from(subscriptionPlans)
        .where(and(eq(subscriptionPlans.isActive, true), eq(subscriptionPlans.isPopular, true)))
        .orderBy(asc(subscriptionPlans.sortOrder))
        .limit(limit);
}
/**
 ...
 */
export async function createSubscriptionPlan(planData, context) {
    const result = await db
 ...
 */
export async function updateSubscriptionPlan(planId, updates, context) {
    const result = await db
 ...
 */
export async function deleteSubscriptionPlan(planId, context) {
    const result = await db
 ...
 */
export async function getUserSubscriptionById(subscriptionId, context) {
    const result = await db
        .select()
 ...
 */
export async function getUserActiveSubscription(userId, context) {
    const result = await db
        .select({
        ...
        .leftJoin(organizations, eq(userSubscriptions.organizationId, organizations.id))
 ...
 */
export async function getUserSubscriptionByStripeId(stripeSubscriptionId, context) {
    const result = await db
        .select()
        .from(userSubscriptions)
 ...
 */
export async function getUserSubscriptionHistory(userId, context, options = {}) {
 ...
 */
export async function getOrganizationSubscriptions(organizationId, context, options = {}) {
 ...
 */
export async function getSubscriptionStats(context, options = {}) {
    ...
    const [stats, activeStats] = await Promise.all([
        ...
        db
            ...
            cancelledSubscriptions: count(sql `CASE WHEN ${userSubscriptions.status} = 'cancelled' THEN 1 END`),
        ...
        db
            ...
            activeRevenue: sql `COALESCE(SUM(${userSubscriptions.amount}), 0)`,
        })
            .from(userSubscriptions)
    ...
    return {
        ...
        churnRate: totalSubscriptions > 0 ? cancelledSubscriptions / totalSubscriptions : 0,
    };
}
/**
 * Create user subscription
 */
export async function createUserSubscription(subscriptionData, context) {
    const result = await db
 ...
 */
export async function updateUserSubscription(subscriptionId, updates, context) {
    const result = await db
 ...
 */
export async function cancelUserSubscription(subscriptionId, context, options = {}) {
 ...
 */
export async function reactivateUserSubscription(subscriptionId, context) {
 ...
 */
export async function getTransactionById(transactionId, context) {
    const result = await db
        .select()
        .from(transactions)
 ...
 */
export async function getTransactionsByUser(userId, context, options = {}) {
 ...
 */
export async function getTransactionsByOrganization(organizationId, context, options = {}) {
    const { status, limit = 50, offset = 0 } = options;
 ...
 * Create transaction
 */
export async function createTransaction(transactionData, context) {
    const result = await db
        .insert(transactions)
        .values({
        ...transactionData,
 ...
 * Update transaction
 */
export async function updateTransaction(transactionId, updates, context) {
    const result = await db
        .update(transactions)
        .set({
        ...updates,
 ...
 */
export async function getPaymentMethodsByUser(userId, context) {
    return db
        .select()
        .from(paymentMethods)
 ...
 */
export async function getDefaultPaymentMethod(userId, context) {
    const result = await db
        .select()
        .from(paymentMethods)
 ...
 */
export async function updatePaymentMethod(paymentMethodId, updates, context) {
    const result = await db
 ...
 */
export async function deletePaymentMethod(paymentMethodId, context) {
    const result = await db
