...
export const assessmentQuestionResponseSchema = assessmentQuestionEntitySchema.extend({
    // Computed fields
    isRequired: z.boolean(),
...
export const assessmentResponseResponseSchema = assessmentResponseEntitySchema.extend({
    // Computed fields
    isSkipped: z.boolean(),
    hasValue: z.boolean(),
    hasText: z.boolean(),
