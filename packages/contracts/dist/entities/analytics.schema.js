...
// CREATE SCHEMAS
// ============================================================================
export const createUserAnalyticsEventSchema = userAnalyticsEventEntitySchema.omit({
    id: true,
    createdAt: true,
});
export const createUserContentInteractionSchema = userContentInteractionEntitySchema.omit({
    id: true,
    createdAt: true,
});
...
export const newUserContentInteractionSchema = createUserContentInteractionSchema;
