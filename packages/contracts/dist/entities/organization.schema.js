...
// ============================================================================
export const organizationMembershipResponseSchema = organizationMembershipEntitySchema.extend({
    // Computed fields
    isActive: z.boolean(),
    isPending: z.boolean(),
    canManage: z.boolean(),
...
// ============================================================================
export const createOrganizationMembershipSchema = organizationMembershipEntitySchema
    .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
// ============================================================================
export const updateOrganizationMembershipSchema = createOrganizationMembershipSchema.partial().omit({
    userId: true,
    organizationId: true,
});
// ============================================================================
