 ...
 */
export const OrganizationQuerySchema = OrganizationEntitySchema.partial().extend({
    // Search fields
 ...
 * Omits auto-generated fields
 */
export const CreateOrganizationMembershipSchema = OrganizationMembershipEntitySchema.omit({
    id: true,
    created_at: true,
    updated_at: true,
});
 ...
 * Makes all fields optional for partial updates
 */
export const UpdateOrganizationMembershipSchema = CreateOrganizationMembershipSchema.partial();
/**
 * Organization Membership Query Schema - For filtering and searching
 * Extends entity with optional filters
 */
export const OrganizationMembershipQuerySchema = OrganizationMembershipEntitySchema.partial().extend({
    // Filter fields
