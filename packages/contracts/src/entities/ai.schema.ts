...
export type AiCrossReferenceSuggestionEntity = z.infer<
  typeof aiCrossReferenceSuggestionEntitySchema
>;
export type TheologicalConceptEntity = z.infer<
  typeof theologicalConceptEntitySchema
>;
...
export const createAiCrossReferenceSuggestionSchema =
  aiCrossReferenceSuggestionEntitySchema.omit({
    id: true,
    createdAt: true,
    reviewedAt: true,
    implementedAt: true,
...
export const createTheologicalConceptSchema =
  theologicalConceptEntitySchema.omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export const updateAiCrossReferenceSuggestionSchema =
  createAiCrossReferenceSuggestionSchema.partial();
export const updateTheologicalConceptSchema =
  createTheologicalConceptSchema.partial();
...
export type CreateAiCrossReferenceSuggestion = z.infer<
  typeof createAiCrossReferenceSuggestionSchema
>;
export type CreateTheologicalConcept = z.infer<
  typeof createTheologicalConceptSchema
>;
...
export type UpdateAiCrossReferenceSuggestion = z.infer<
  typeof updateAiCrossReferenceSuggestionSchema
>;
export type UpdateTheologicalConcept = z.infer<
  typeof updateTheologicalConceptSchema
>;
...
export const aiCrossReferenceSuggestionSchema =
...
export const newAiCrossReferenceSuggestionSchema =
