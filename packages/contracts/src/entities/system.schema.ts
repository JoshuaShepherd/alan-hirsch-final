...
export const createSystemNotificationSchema =
  systemNotificationEntitySchema.omit({
    id: true,
    createdAt: true,
    updatedAt: true,
  });

export const createUserNotificationStatusSchema =
  userNotificationStatusEntitySchema.omit({
    id: true,
    createdAt: true,
    updatedAt: true,
  });
...
export const updateUserFeatureFlagSchema =
  createUserFeatureFlagSchema.partial();
export const updateUserConsentSchema = createUserConsentSchema.partial();
export const updateSystemNotificationSchema =
  createSystemNotificationSchema.partial();
export const updateUserNotificationStatusSchema =
  createUserNotificationStatusSchema.partial();
...
export type SystemNotificationEntity = z.infer<
  typeof systemNotificationEntitySchema
>;
...
export type UpdateSystemNotification = z.infer<
  typeof updateSystemNotificationSchema
>;
...
export const newUserNotificationStatusSchema =
