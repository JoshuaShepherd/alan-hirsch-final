...
export const updateAiCrossReferenceSuggestionSchema =
  createAiCrossReferenceSuggestionSchema.partial().extend({
    status: z
...
export type AiCrossReferenceSuggestionQuery = z.infer<
  typeof aiCrossReferenceSuggestionQuerySchema
>;
export type TheologicalConceptQuery = z.infer<
  typeof theologicalConceptQuerySchema
>;
