import { z } from 'zod';
import {
  createOrganizationMembershipSchema as CreateOrganizationMembershipSchema,
  createOrganizationSchema as CreateOrganizationSchema,
  organizationInvitationSchema as OrganizationInvitationSchema,
  organizationMembershipQuerySchema as OrganizationMembershipQuerySchema,
  organizationQuerySchema as OrganizationQuerySchema,
  updateOrganizationMembershipSchema as UpdateOrganizationMembershipSchema,
 ...
 */
export const CreateOrganizationOperationSchema =
  CreateOrganizationSchema.extend({
    ...
    subdomain: z
      ...
      .regex(/^[a-z0-9-]+$/)
      .refine(
        subdomain => !subdomain.startsWith('-') && !subdomain.endsWith('-'),
        { message: 'Subdomain cannot start or end with hyphens' }
      )
      .optional(),
  });
 ...
 */
export const UpdateOrganizationOperationSchema =
 ...
 */
export const CreateOrganizationMembershipOperationSchema =
  CreateOrganizationMembershipSchema.extend({
    // Additional validation for create operations
 ...
 */
export const UpdateOrganizationMembershipOperationSchema =
  UpdateOrganizationMembershipSchema.extend({
    // Ensure at least one field is provided for update
  }).refine(data => Object.keys(data).length > 0, {
    message: 'At least one field must be provided for update',
  });
 ...
 */
export const InviteUserToOrganizationOperationSchema =
 ...
 */
export const ListOrganizationMembershipsOperationSchema =
  OrganizationMembershipQuerySchema.extend({
    // Pagination
    page: z.number().int().min(1).default(1),
    limit: z.number().int().min(1).max(100).default(20),
    offset: z.number().int().min(0).default(0),
...
// Organization CRUD Operations
export type CreateOrganizationOperation = z.infer<
  typeof CreateOrganizationOperationSchema
>;
export type UpdateOrganizationOperation = z.infer<
  typeof UpdateOrganizationOperationSchema
>;
export type GetOrganizationByIdOperation = z.infer<
  typeof GetOrganizationByIdOperationSchema
>;
export type GetOrganizationBySubdomainOperation = z.infer<
  typeof GetOrganizationBySubdomainOperationSchema
>;
export type ListOrganizationsOperation = z.infer<
  typeof ListOrganizationsOperationSchema
>;
export type SearchOrganizationsOperation = z.infer<
  typeof SearchOrganizationsOperationSchema
>;

// Organization Membership Operations
export type CreateOrganizationMembershipOperation = z.infer<
  typeof CreateOrganizationMembershipOperationSchema
>;
export type UpdateOrganizationMembershipOperation = z.infer<
  typeof UpdateOrganizationMembershipOperationSchema
>;
export type InviteUserToOrganizationOperation = z.infer<
  typeof InviteUserToOrganizationOperationSchema
>;
export type AcceptOrganizationInvitationOperation = z.infer<
  typeof AcceptOrganizationInvitationOperationSchema
>;
export type RejectOrganizationInvitationOperation = z.infer<
  typeof RejectOrganizationInvitationOperationSchema
>;
export type RemoveUserFromOrganizationOperation = z.infer<
  typeof RemoveUserFromOrganizationOperationSchema
>;
export type GetOrganizationMembersOperation = z.infer<
  typeof GetOrganizationMembersOperationSchema
>;
export type ListOrganizationMembershipsOperation = z.infer<
  typeof ListOrganizationMembershipsOperationSchema
>;

// Organization Settings Operations
export type UpdateOrganizationSettingsOperation = z.infer<
  typeof UpdateOrganizationSettingsOperationSchema
>;
export type UpdateOrganizationBrandingOperation = z.infer<
  typeof UpdateOrganizationBrandingOperationSchema
>;

// Organization Analytics Operations
export type GetOrganizationStatisticsOperation = z.infer<
  typeof GetOrganizationStatisticsOperationSchema
>;
export type GetOrganizationDashboardOperation = z.infer<
  typeof GetOrganizationDashboardOperationSchema
>;
