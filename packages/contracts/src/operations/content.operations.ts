...
export const CreateContentItemOperationSchema = CreateContentItemSchema.extend({
  ...
  title: z
    ...
    .max(500)
    .refine(
      title => !title.includes('  '), // No double spaces
...
export const SearchContentItemsOperationSchema = z.object({
  ...
  status: z
    .array(
      z.enum(['draft', 'published', 'archived', 'scheduled', 'under_review'])
    )
    .optional(),
  visibility: z
 ...
 */
export const CreateContentCategoryOperationSchema =
  CreateContentCategorySchema.extend({
    // Additional validation for create operations
    name: z
      .string()
      .min(1)
 ...
 */
export const UpdateContentCategoryOperationSchema =
  UpdateContentCategorySchema.extend({
    // Ensure at least one field is provided for update
  }).refine(data => Object.keys(data).length > 0, {
    message: 'At least one field must be provided for update',
  });
 ...
 */
export const ListContentCategoriesOperationSchema =
  ContentCategoryQuerySchema.extend({
    // Pagination
    page: z.number().int().min(1).default(1),
    limit: z.number().int().min(1).max(100).default(20),
    offset: z.number().int().min(0).default(0),
 ...
 */
export const CreateContentSeriesOperationSchema =
  CreateContentSeriesSchema.extend({
    // Additional validation for create operations
    title: z
      .string()
      .min(1)
 ...
 */
export const UpdateContentSeriesOperationSchema =
  UpdateContentSeriesSchema.extend({
    // Ensure at least one field is provided for update
  }).refine(data => Object.keys(data).length > 0, {
    message: 'At least one field must be provided for update',
  });
 ...
 */
export const CreateContentCrossReferenceOperationSchema =
  CreateContentCrossReferenceSchema.extend({
    // Additional validation for create operations
 ...
 */
export const UpdateContentCrossReferenceOperationSchema =
  UpdateContentCrossReferenceSchema.extend({
    // Ensure at least one field is provided for update
  }).refine(data => Object.keys(data).length > 0, {
    message: 'At least one field must be provided for update',
  });
...
export const GetContentCrossReferencesOperationSchema = z.object({
  ...
  reference_type: z
    .array(
      z.enum(['citation', 'quotation', 'expansion', 'contradiction', 'support'])
    )
    .optional(),
 ...
 */
export const ListContentCrossReferencesOperationSchema =
  ContentCrossReferenceQuerySchema.extend({
    // Pagination
    page: z.number().int().min(1).default(1),
    limit: z.number().int().min(1).max(100).default(20),
    offset: z.number().int().min(0).default(0),
...
// Content Item Operations
export type CreateContentItemOperation = z.infer<
  typeof CreateContentItemOperationSchema
>;
export type UpdateContentItemOperation = z.infer<
  typeof UpdateContentItemOperationSchema
>;
export type PublishContentItemOperation = z.infer<
  typeof PublishContentItemOperationSchema
>;
export type ScheduleContentItemOperation = z.infer<
  typeof ScheduleContentItemOperationSchema
>;
export type GetContentItemOperation = z.infer<
  typeof GetContentItemOperationSchema
>;
export type ListContentItemsOperation = z.infer<
  typeof ListContentItemsOperationSchema
>;
export type SearchContentItemsOperation = z.infer<
  typeof SearchContentItemsOperationSchema
>;

// Content Category Operations
export type CreateContentCategoryOperation = z.infer<
  typeof CreateContentCategoryOperationSchema
>;
export type UpdateContentCategoryOperation = z.infer<
  typeof UpdateContentCategoryOperationSchema
>;
export type ReorderContentCategoriesOperation = z.infer<
  typeof ReorderContentCategoriesOperationSchema
>;
export type GetContentCategoryOperation = z.infer<
  typeof GetContentCategoryOperationSchema
>;
export type ListContentCategoriesOperation = z.infer<
  typeof ListContentCategoriesOperationSchema
>;

// Content Series Operations
export type CreateContentSeriesOperation = z.infer<
  typeof CreateContentSeriesOperationSchema
>;
export type UpdateContentSeriesOperation = z.infer<
  typeof UpdateContentSeriesOperationSchema
>;
export type AddContentToSeriesOperation = z.infer<
  typeof AddContentToSeriesOperationSchema
>;
export type RemoveContentFromSeriesOperation = z.infer<
  typeof RemoveContentFromSeriesOperationSchema
>;
export type ReorderSeriesContentOperation = z.infer<
  typeof ReorderSeriesContentOperationSchema
>;
export type GetContentSeriesOperation = z.infer<
  typeof GetContentSeriesOperationSchema
>;
export type ListContentSeriesOperation = z.infer<
  typeof ListContentSeriesOperationSchema
>;

// Content Cross Reference Operations
export type CreateContentCrossReferenceOperation = z.infer<
  typeof CreateContentCrossReferenceOperationSchema
>;
export type UpdateContentCrossReferenceOperation = z.infer<
  typeof UpdateContentCrossReferenceOperationSchema
>;
export type GetContentCrossReferencesOperation = z.infer<
  typeof GetContentCrossReferencesOperationSchema
>;
export type ListContentCrossReferencesOperation = z.infer<
  typeof ListContentCrossReferencesOperationSchema
>;

// Content Analytics Operations
export type GetContentAnalyticsOperation = z.infer<
  typeof GetContentAnalyticsOperationSchema
>;
export type GetContentPerformanceOperation = z.infer<
  typeof GetContentPerformanceOperationSchema
>;
