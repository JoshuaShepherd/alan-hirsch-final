 ...
 */
export const CreateUserWithOrganizationApiRequestSchema =
  CreateUserWithOrganizationOperationSchema;
 ...
 */
export const UserPasswordResetApiRequestSchema =
  UserPasswordResetOperationSchema;
 ...
 */
export const UserPasswordUpdateApiRequestSchema =
  UserPasswordUpdateOperationSchema;
 ...
 */
export const UpdateUserProfileApiRequestSchema =
  UpdateUserProfileOperationSchema;
 ...
 */
export const UpdateUserSettingsApiRequestSchema =
  UpdateUserSettingsOperationSchema;
 ...
 */
export const UpdateUserAssessmentScoresApiRequestSchema =
  UpdateUserAssessmentScoresOperationSchema;
 ...
 */
export const UserListApiResponseSchema = PaginatedResponseSchema(
...
export type CreateUserWithOrganizationApiRequest = z.infer<
  typeof CreateUserWithOrganizationApiRequestSchema
>;
export type UserLoginApiRequest = z.infer<typeof UserLoginApiRequestSchema>;
export type UserRegistrationApiRequest = z.infer<
  typeof UserRegistrationApiRequestSchema
>;
export type UserPasswordResetApiRequest = z.infer<
  typeof UserPasswordResetApiRequestSchema
>;
export type UserPasswordUpdateApiRequest = z.infer<
  typeof UserPasswordUpdateApiRequestSchema
>;
export type UpdateUserProfileApiRequest = z.infer<
  typeof UpdateUserProfileApiRequestSchema
>;
export type UpdateUserSettingsApiRequest = z.infer<
  typeof UpdateUserSettingsApiRequestSchema
>;
export type UpdateUserAssessmentScoresApiRequest = z.infer<
  typeof UpdateUserAssessmentScoresApiRequestSchema
>;
export type DeleteUserApiRequest = z.infer<typeof DeleteUserApiRequestSchema>;
export type DeactivateUserApiRequest = z.infer<
  typeof DeactivateUserApiRequestSchema
>;
...
export type UserWithOrganizationsApiResponse = z.infer<
  typeof UserWithOrganizationsApiResponseSchema
>;
export type UserWithAssessmentsApiResponse = z.infer<
  typeof UserWithAssessmentsApiResponseSchema
>;
export type UserListApiResponse = z.infer<
  ReturnType<typeof PaginatedResponseSchema<typeof PublicUserApiResponseSchema>>
>;
...
export type UserProfileUpdateApiResponse = z.infer<
  typeof UserProfileUpdateApiResponseSchema
>;
export type UserSettingsUpdateApiResponse = z.infer<
  typeof UserSettingsUpdateApiResponseSchema
>;
export type UserAssessmentScoresUpdateApiResponse = z.infer<
  typeof UserAssessmentScoresUpdateApiResponseSchema
>;

// User API Query Types
export type GetUserByIdApiQuery = z.infer<typeof GetUserByIdApiQuerySchema>;
export type GetUserByEmailApiQuery = z.infer<
  typeof GetUserByEmailApiQuerySchema
>;
