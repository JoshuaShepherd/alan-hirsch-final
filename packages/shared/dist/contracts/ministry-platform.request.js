import { z } from 'zod';
import { culturalContextSchema, membershipRoleSchema, ministryRoleSchema, organizationTypeSchema, } from '../../validations/shared';
// ============================================================================
...
export const ministryPlatformSearchRequestSchema = z.object({
    ...
    contentTypes: z
        .array(z.enum(['article', 'video', 'podcast', 'framework', 'tool', 'case_study']))
        .optional(),
    difficultyLevels: z
...
export const updateMinistryAssessmentRequestSchema = createMinistryAssessmentRequestSchema.partial();
...
export const updateMinistryContentRequestSchema = createMinistryContentRequestSchema.partial();
// ============================================================================
...
export const updateMinistryCommunityRequestSchema = createMinistryCommunityRequestSchema.partial();
...
export const updateMinistryOrganizationRequestSchema = createMinistryOrganizationRequestSchema.partial();
...
export const updateMinistryCollaborationRequestSchema = createMinistryCollaborationRequestSchema.partial();
// ============================================================================
...
//# sourceMappingURL=ministry-platform.request.js.map