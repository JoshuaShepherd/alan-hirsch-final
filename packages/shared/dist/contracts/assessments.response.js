...
export const assessmentWithQuestionsResponseSchema = assessmentResponseSchema.extend({
    questions: z.array(assessmentQuestionResponseSchema),
});
// User Assessment with Assessment Details Response DTO
export const userAssessmentWithDetailsResponseSchema = userAssessmentResponseSchema.extend({
    assessment: z.object({
        id: z.string().uuid(),
        name: z.string(),
        slug: z.string(),
...
//# sourceMappingURL=assessments.response.js.map