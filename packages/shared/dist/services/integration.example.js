 ...
 */
export async function GET_USER_EXAMPLE(request, { params }) {
    try {
 ...
 */
export async function POST_USER_EXAMPLE(request) {
    try {
 ...
 */
export async function PUT_USER_EXAMPLE(request, { params }) {
    try {
        const body = await request.json();
        const userService = services.user();
 ...
 */
export async function COMPLETE_ASSESSMENT_EXAMPLE(request, { params }) {
    try {
        const body = await request.json();
        ...
        const result = await ServiceUtils.executeInTransaction(async (services) => {
            ...
            const completedAssessment = await userAssessmentService.completeAssessment(params.id, completionData);
            return {
 ...
 */
export async function CREATE_CONTENT_EXAMPLE(request) {
    try {
        const body = await request.json();
 ...
 */
export async function PUBLISH_CONTENT_EXAMPLE(request, { params }) {
    try {
        const contentService = services.contentItem();
 ...
 */
export async function SEARCH_CONTENT_EXAMPLE(request) {
    try {
 ...
 */
export async function ADD_ORGANIZATION_MEMBER_EXAMPLE(request, { params }) {
    try {
        const body = await request.json();
        ...
        const membership = await organizationMembershipService.addMember(userId, params.id, role);
        return NextResponse.json({
            success: true,
            data: membership,
            timestamp: new Date().toISOString(),
 ...
 */
export async function GET_USER_STATS_EXAMPLE(request, { params }) {
    try {
        const userService = services.user();
 ...
 */
async function trackContentPublished(contentId) {
