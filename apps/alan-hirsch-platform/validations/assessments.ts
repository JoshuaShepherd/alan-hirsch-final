...
export const newAssessmentSchema = assessmentSchema
  .omit({
    createdAt: true,
    updatedAt: true,
  })
...
export const newAssessmentQuestionSchema = assessmentQuestionSchema
  .omit({
    createdAt: true,
    updatedAt: true,
  })
...
export const newUserAssessmentSchema = userAssessmentSchema
  .omit({
    createdAt: true,
    updatedAt: true,
  })
...
export const newAssessmentResponseSchema = assessmentResponseSchema
  .omit({
    createdAt: true,
    updatedAt: true,
  })
...
export type AssessmentWithQuestions = z.infer<
  typeof assessmentWithQuestionsSchema
>;
