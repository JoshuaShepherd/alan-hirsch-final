  ...
  return (
    <Card className={cn('h-full', className)}>
      ...
      <CardContent className="pb-3">
        ...
        {showMinistryInfo && (
          <div className="space-y-2 mb-3">
            <div className="flex items-center space-x-2">
              ...
              <Badge
                className={getSubscriptionTierColor(user.subscriptionTier)}
              >
        ...
        {/* Assessment Scores */}
        {showAssessmentScores && user.assessmentTotal && (
          <div className="space-y-2 mb-3">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{ width: `${(user.assessmentTotal / 600) * 100}%` }}
              />
            </div>
          </div>
        )}
        ...
        {/* Contact Information */}
        {showContactInfo && variant === 'detailed' && (
