import { SaveResponsesInput, saveResponsesInputSchema } from '@/lib/contracts';
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2">
            {questions.map((_, index) => {
              const response = form
                .watch('responses')
                .find((r: any) => r.questionId === questions[index].id);
              const isAnswered =
                response &&
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                value={form
                  .watch('responses')
                  .find((r: any) => r.questionId === currentQuestion.id)
                  ?.confidence?.toString()}
                onValueChange={value =>
