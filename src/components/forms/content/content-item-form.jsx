'use client';
import { contentItemFormSchema } from '@/lib/contracts';
...
export function ContentItemForm({
  ...
  const [theologicalThemes, setTheologicalThemes] = useState(
  ...
  const removeTheologicalTheme = index => {
    setTheologicalThemes(theologicalThemes.filter((_, i) => i !== index));
  };
  const updateTheologicalTheme = (index, value) => {
      ...
      <CardContent>
        ...
        >
          ...
          >
            ...
            >
              <Select
                onValueChange={value => form.setValue('licenseType', value)}
              >
                <SelectTrigger>
