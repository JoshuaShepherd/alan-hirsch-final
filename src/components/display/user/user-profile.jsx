...
import { AlertCircle, Building, Calendar, CheckCircle, Clock, Edit, Globe, Mail, MapPin, Users, XCircle, } from 'lucide-react';
export function UserProfile({ data: user, isLoading = false, error = null, showFullProfile = true, showAssessmentResults = true, showCommunityActivity = false, showCollaborationHistory = false, onEdit, onDelete, onView, className, }) {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-2">
                  <Badge className={cn('text-sm', getMinistryRoleColor(user.ministryRole))}>
                    {user.ministryRole.replace('_', ' ')}
                  </Badge>
                  {user.leaderTier && (<Badge variant="outline">{user.leaderTier}</Badge>)}
                  <Badge className={cn('text-sm', getSubscriptionTierColor(user.subscriptionTier))}>
            ...
            {onEdit && (<Button onClick={() => onEdit(user)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {showAssessmentResults &&
            (user.assessmentTotal || user.assessmentMovementAlignment) && (<Card>
                <CardHeader>
                  <CardTitle>Assessment Results</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  {user.assessmentTotal && (<div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {user.assessmentMovementAlignment && (<div className="text-center">
                    ...
                    {user.assessmentAudienceEngagement && (<div className="text-center">
                        <div className="text-2xl font-bold">
                    ...
                    {user.assessmentContentReadiness && (<div className="text-center">
                        <div className="text-2xl font-bold">
                    ...
                    {user.assessmentRevenuePotential && (<div className="text-center">
                        <div className="text-2xl font-bold">
                    ...
                    {user.assessmentNetworkEffects && (<div className="text-center">
                        <div className="text-2xl font-bold">
                    ...
                    {user.assessmentStrategicFit && (<div className="text-center">
                        <div className="text-2xl font-bold">
          ...
          {showFullProfile && (user.platformTitle || user.subdomain) && (<Card>
              <CardHeader>
                <CardTitle>Platform Configuration</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {user.platformTitle && (<div className="flex items-center space-x-3">
                  ...
                  {user.subdomain && (<div className="flex items-center space-x-3">
                      <Globe className="h-5 w-5 text-muted-foreground"/>
                      <div>
                  ...
                  {user.customDomain && (<div className="flex items-center space-x-3">
                      <Globe className="h-5 w-5 text-muted-foreground"/>
                      <div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {user.timezone && (<div className="flex items-center space-x-3">
                  <Clock className="h-4 w-4 text-muted-foreground"/>
                  <span className="text-sm">{user.timezone}</span>
                </div>)}
              {user.languagePrimary && (<div className="flex items-center space-x-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge className={user.onboardingCompleted
            ? 'bg-green-100 text-green-800'
            : 'bg-yellow-100 text-yellow-800'}>
                  {user.onboardingCompleted ? 'Completed' : 'In Progress'}
                </Badge>
              </div>
              {!user.onboardingCompleted && (<div className="flex items-center justify-between">
          ...
          {/* Theological Focus */}
          {user.theologicalFocus && user.theologicalFocus.length > 0 && (<Card>
              <CardHeader>
                <CardTitle>Theological Focus</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {user.theologicalFocus.map((focus, index) => (<Badge key={index} variant="outline">
                      {focus}
                    </Badge>))}
                </div>
              </CardContent>
          ...
          {showFullProfile && (<Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={user.privacySettings.publicProfile
                ? 'bg-green-100 text-green-800'
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={user.privacySettings.showAssessmentResults
                ? 'bg-green-100 text-green-800'
                : 'bg-red-100 text-red-800'}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={user.privacySettings.allowNetworking
                ? 'bg-green-100 text-green-800'
                : 'bg-red-100 text-red-800'}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={user.privacySettings.shareAnalytics
                ? 'bg-green-100 text-green-800'
                : 'bg-red-100 text-red-800'}>
