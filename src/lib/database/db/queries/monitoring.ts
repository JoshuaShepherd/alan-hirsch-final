 ...
 */
export async function getDatabaseHealth(context: Ctx): Promise<DatabaseHealth> {
...
export async function trackAnalyticsEvent(
  ...
  try {
    await db.insert(userAnalyticsEvents).values({
      ...
      organizationId: eventData.organizationId || context.tenantId,
 ...
 * Get system metrics
 */
export async function getSystemMetrics(context: Ctx): Promise<{
  totalUsers: number;
  activeUsers: number;
  totalContent: number;
