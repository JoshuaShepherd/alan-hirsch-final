...
describe('User Queries Contract', () => {
  it('should export all required CRUD functions', () => {
    ...
    expect(typeof userQueries.getById).toBe('function');
    expect(typeof userQueries.list).toBe('function');
    expect(typeof userQueries.create).toBe('function');
    expect(typeof userQueries.update).toBe('function');
    expect(typeof userQueries.remove).toBe('function');
  });
  ...
  it('should have correct function signatures', () => {
    ...
    ) => Promise<any> = userQueries.list;
    const createFn: (ctx: Ctx, data: any) => Promise<any> = userQueries.create;
  ...
  it('should return list envelope with correct structure', async () => {
    ...
    const result = await userQueries.list(mockCtx);
