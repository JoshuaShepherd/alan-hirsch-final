/**
 * Community Queries Contract Tests
...
describe('Community Queries Contract', () => {
  it('should export all required CRUD functions', () => {
    // Type-level check - these should exist
    expect(typeof communityQueries.getById).toBe('function');
    expect(typeof communityQueries.list).toBe('function');
    expect(typeof communityQueries.create).toBe('function');
    expect(typeof communityQueries.update).toBe('function');
    expect(typeof communityQueries.remove).toBe('function');
  });
  ...
  it('should return list envelope with correct structure', async () => {
    ...
    const result = await communityQueries.list(mockCtx);
