...
contentCategories = pgTable('content_categories', {
...
// Export the contentCategories table
...
export const contentSeries = pgTable('content_series', {
  ...
  collaborators: jsonb('collaborators').$type<string[]>().default([]), // User IDs
...
export const seriesContentItems = pgTable('series_content_items', {
  ...
  // Prerequisites
  prerequisites: jsonb('prerequisites').$type<string[]>().default([]), // Content IDs
...
export const contentSeriesRelations = relations(
  contentSeries,
  ({ one, many }) => ({
...
export const seriesContentItemsRelations = relations(
  seriesContentItems,
  ({ one }) => ({
    series: one(contentSeries, {
...
export const contentCrossReferencesRelations = relations(
...
export type NewContentCrossReference =
