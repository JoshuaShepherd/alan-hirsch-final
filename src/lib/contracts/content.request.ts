...
export const updateContentItemRequestSchema = z
  ...
  .merge(
    createContentItemRequestSchema.partial().omit({
...
export const updateContentCategoryRequestSchema = z
  ...
  .merge(
    createContentCategoryRequestSchema.partial().omit({
      slug: true, // Slug shouldn't be updatable
    })
  );
...
export const updateContentSeriesRequestSchema = z
  ...
  .merge(
    createContentSeriesRequestSchema.partial().omit({
      slug: true, // Slug shouldn't be updatable
    })
  );
...
>;
export type UpdateContentCategoryRequest = z.infer<
  typeof updateContentCategoryRequestSchema
>;
export type CreateContentSeriesRequest = z.infer<
  typeof createContentSeriesRequestSchema
>;
export type UpdateContentSeriesRequest = z.infer<
  typeof updateContentSeriesRequestSchema
>;
