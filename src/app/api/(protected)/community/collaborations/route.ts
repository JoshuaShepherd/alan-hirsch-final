// Auto-generated collection route for Collaborations
...
// import { collaborationsQuerySchema, collaborationsInputSchema } from '@/lib/contracts';
// import { collaborationsArrayToApi, collaborationsFromApi } from '@/lib/mappers';
// import type { CollaborationsSelect, CollaborationsInsert, CollaborationsResponse } from '@/lib/types';
...
// GET /api/collaborations - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching Collaborations list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch Collaborations list',
      },
    }, { status: 500 });
  }
}

// POST /api/collaborations - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      data: result,
      message: 'Collaborations created successfully',
    }, { status: 201 });
  } catch (error) {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create Collaborations',
      },
    }, { status: 500 });
  }
}