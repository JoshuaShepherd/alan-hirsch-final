// Auto-generated bulk operations route for CommunityPostVotes
...
// import { communitypostvotesBulkSchema } from '@/lib/contracts';
// import { communitypostvotesArrayToApi, communitypostvotesArrayFromApi } from '@/lib/mappers';
// import type { CommunityPostVotesSelect, CommunityPostVotesInsert, CommunityPostVotesUpdate, CommunityPostVotesResponse } from '@/lib/types';
...
// POST /api/communityPostVotes/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk CommunityPostVotes operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk CommunityPostVotes operation',
      },
    }, { status: 500 });
  }
}