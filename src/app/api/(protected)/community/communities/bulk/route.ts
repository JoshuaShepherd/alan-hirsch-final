// Auto-generated bulk operations route for Communities
...
// import { communitiesBulkSchema } from '@/lib/contracts';
// import { communitiesArrayToApi, communitiesArrayFromApi } from '@/lib/mappers';
// import type { CommunitiesSelect, CommunitiesInsert, CommunitiesUpdate, CommunitiesResponse } from '@/lib/types';
...
// POST /api/communities/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk Communities operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk Communities operation',
      },
    }, { status: 500 });
  }
}