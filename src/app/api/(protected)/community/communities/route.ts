// Auto-generated collection route for Communities
...
// import { communitiesQuerySchema, communitiesInputSchema } from '@/lib/contracts';
// import { communitiesArrayToApi, communitiesFromApi } from '@/lib/mappers';
// import type { CommunitiesSelect, CommunitiesInsert, CommunitiesResponse } from '@/lib/types';
...
// GET /api/communities - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch Communities list',
      },
    }, { status: 500 });
  }
}

// POST /api/communities - Create new entity
