// Auto-generated bulk operations route for UserFeatureFlags
...
// import { userfeatureflagsBulkSchema } from '@/lib/contracts';
// import { userfeatureflagsArrayToApi, userfeatureflagsArrayFromApi } from '@/lib/mappers';
// import type { UserFeatureFlagsSelect, UserFeatureFlagsInsert, UserFeatureFlagsUpdate, UserFeatureFlagsResponse } from '@/lib/types';
...
// POST /api/userFeatureFlags/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk UserFeatureFlags operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk UserFeatureFlags operation',
      },
    }, { status: 500 });
  }
}