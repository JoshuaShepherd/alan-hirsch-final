// Auto-generated bulk operations route for ApiKeys
...
// import { apikeysBulkSchema } from '@/lib/contracts';
// import { apikeysArrayToApi, apikeysArrayFromApi } from '@/lib/mappers';
// import type { ApiKeysSelect, ApiKeysInsert, ApiKeysUpdate, ApiKeysResponse } from '@/lib/types';
...
// POST /api/apiKeys/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk ApiKeys operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk ApiKeys operation',
      },
    }, { status: 500 });
  }
}