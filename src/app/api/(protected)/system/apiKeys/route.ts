// Auto-generated collection route for ApiKeys
...
// import { apikeysQuerySchema, apikeysInputSchema } from '@/lib/contracts';
// import { apikeysArrayToApi, apikeysFromApi } from '@/lib/mappers';
// import type { ApiKeysSelect, ApiKeysInsert, ApiKeysResponse } from '@/lib/types';
...
// GET /api/apiKeys - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching ApiKeys list:', error);
...
// POST /api/apiKeys - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating ApiKeys:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create ApiKeys',
      },
    }, { status: 500 });
  }
}