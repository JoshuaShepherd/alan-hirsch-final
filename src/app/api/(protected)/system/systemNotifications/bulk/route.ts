// Auto-generated bulk operations route for SystemNotifications
...
// import { systemnotificationsBulkSchema } from '@/lib/contracts';
// import { systemnotificationsArrayToApi, systemnotificationsArrayFromApi } from '@/lib/mappers';
// import type { SystemNotificationsSelect, SystemNotificationsInsert, SystemNotificationsUpdate, SystemNotificationsResponse } from '@/lib/types';
...
// POST /api/systemNotifications/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk SystemNotifications operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk SystemNotifications operation',
      },
    }, { status: 500 });
  }
}