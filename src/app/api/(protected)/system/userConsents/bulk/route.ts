// Auto-generated bulk operations route for UserConsents
...
// import { userconsentsBulkSchema } from '@/lib/contracts';
// import { userconsentsArrayToApi, userconsentsArrayFromApi } from '@/lib/mappers';
// import type { UserConsentsSelect, UserConsentsInsert, UserConsentsUpdate, UserConsentsResponse } from '@/lib/types';
...
// POST /api/userConsents/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk UserConsents operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk UserConsents operation',
      },
    }, { status: 500 });
  }
}