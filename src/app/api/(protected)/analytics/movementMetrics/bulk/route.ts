// Auto-generated bulk operations route for MovementMetrics
...
// import { movementmetricsBulkSchema } from '@/lib/contracts';
// import { movementmetricsArrayToApi, movementmetricsArrayFromApi } from '@/lib/mappers';
// import type { MovementMetricsSelect, MovementMetricsInsert, MovementMetricsUpdate, MovementMetricsResponse } from '@/lib/types';
...
// POST /api/movementMetrics/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk MovementMetrics operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk MovementMetrics operation',
      },
    }, { status: 500 });
  }
}