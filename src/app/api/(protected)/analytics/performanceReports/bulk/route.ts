// Auto-generated bulk operations route for PerformanceReports
...
// import { performancereportsBulkSchema } from '@/lib/contracts';
// import { performancereportsArrayToApi, performancereportsArrayFromApi } from '@/lib/mappers';
// import type { PerformanceReportsSelect, PerformanceReportsInsert, PerformanceReportsUpdate, PerformanceReportsResponse } from '@/lib/types';
...
// POST /api/performanceReports/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk PerformanceReports operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk PerformanceReports operation',
      },
    }, { status: 500 });
  }
}