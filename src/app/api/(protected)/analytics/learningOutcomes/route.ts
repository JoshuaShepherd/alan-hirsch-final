// Auto-generated collection route for LearningOutcomes
...
// import { learningoutcomesQuerySchema, learningoutcomesInputSchema } from '@/lib/contracts';
// import { learningoutcomesArrayToApi, learningoutcomesFromApi } from '@/lib/mappers';
// import type { LearningOutcomesSelect, LearningOutcomesInsert, LearningOutcomesResponse } from '@/lib/types';
...
// GET /api/learningOutcomes - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching LearningOutcomes list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch LearningOutcomes list',
      },
    }, { status: 500 });
  }
}

// POST /api/learningOutcomes - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      data: result,
      message: 'LearningOutcomes created successfully',
    }, { status: 201 });
  } catch (error) {
    console.error('Error creating LearningOutcomes:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create LearningOutcomes',
      },
    }, { status: 500 });
  }
}