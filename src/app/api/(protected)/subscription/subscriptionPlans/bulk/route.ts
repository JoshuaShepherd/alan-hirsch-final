// Auto-generated bulk operations route for SubscriptionPlans
...
// import { subscriptionplansBulkSchema } from '@/lib/contracts';
// import { subscriptionplansArrayToApi, subscriptionplansArrayFromApi } from '@/lib/mappers';
// import type { SubscriptionPlansSelect, SubscriptionPlansInsert, SubscriptionPlansUpdate, SubscriptionPlansResponse } from '@/lib/types';
...
// POST /api/subscriptionPlans/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk SubscriptionPlans operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk SubscriptionPlans operation',
      },
    }, { status: 500 });
  }
}