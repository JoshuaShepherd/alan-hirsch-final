// Auto-generated bulk operations route for PaymentMethods
...
// import { paymentmethodsBulkSchema } from '@/lib/contracts';
// import { paymentmethodsArrayToApi, paymentmethodsArrayFromApi } from '@/lib/mappers';
// import type { PaymentMethodsSelect, PaymentMethodsInsert, PaymentMethodsUpdate, PaymentMethodsResponse } from '@/lib/types';
...
// POST /api/paymentMethods/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk PaymentMethods operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk PaymentMethods operation',
      },
    }, { status: 500 });
  }
}