// Auto-generated entity route for PaymentMethods
...
// import { paymentmethodsUpdateSchema } from '@/lib/contracts';
// import { paymentmethodsToApi, paymentmethodsFromApi } from '@/lib/mappers';
// import type { PaymentMethodsSelect, PaymentMethodsUpdate, PaymentMethodsResponse } from '@/lib/types';
...
// GET /api/paymentMethods/[id] - Get single entity
  ...
  try {
    ...
    if (!result) {
      return NextResponse.json({
        ...
        error: {
          code: 'NOT_FOUND',
          message: 'PaymentMethods not found',
        },
      }, { status: 404 });
    }
...
// PUT /api/paymentMethods/[id] - Update entity
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to update PaymentMethods',
      },
    }, { status: 500 });
  }
}

// DELETE /api/paymentMethods/[id] - Delete entity
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to delete PaymentMethods',
      },
    }, { status: 500 });
  }
}