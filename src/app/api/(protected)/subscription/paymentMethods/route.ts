// Auto-generated collection route for PaymentMethods
...
// import { paymentmethodsQuerySchema, paymentmethodsInputSchema } from '@/lib/contracts';
// import { paymentmethodsArrayToApi, paymentmethodsFromApi } from '@/lib/mappers';
// import type { PaymentMethodsSelect, PaymentMethodsInsert, PaymentMethodsResponse } from '@/lib/types';
...
// GET /api/paymentMethods - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching PaymentMethods list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch PaymentMethods list',
      },
    }, { status: 500 });
  }
}

// POST /api/paymentMethods - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create PaymentMethods',
      },
    }, { status: 500 });
  }
}