// Auto-generated collection route for Coupons
...
// import { couponsQuerySchema, couponsInputSchema } from '@/lib/contracts';
// import { couponsArrayToApi, couponsFromApi } from '@/lib/mappers';
// import type { CouponsSelect, CouponsInsert, CouponsResponse } from '@/lib/types';
...
// GET /api/coupons - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch Coupons list',
      },
    }, { status: 500 });
  }
}

// POST /api/coupons - Create new entity
