// Auto-generated bulk operations route for Coupons
...
// import { couponsBulkSchema } from '@/lib/contracts';
// import { couponsArrayToApi, couponsArrayFromApi } from '@/lib/mappers';
// import type { CouponsSelect, CouponsInsert, CouponsUpdate, CouponsResponse } from '@/lib/types';
...
// POST /api/coupons/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk Coupons operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk Coupons operation',
      },
    }, { status: 500 });
  }
}