// Auto-generated collection route for UserProfiles
...
// import { userprofilesQuerySchema, userprofilesInputSchema } from '@/lib/contracts';
// import { userprofilesArrayToApi, userprofilesFromApi } from '@/lib/mappers';
// import type { UserProfilesSelect, UserProfilesInsert, UserProfilesResponse } from '@/lib/types';
...
// GET /api/userProfiles - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching UserProfiles list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch UserProfiles list',
      },
    }, { status: 500 });
  }
}

// POST /api/userProfiles - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating UserProfiles:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create UserProfiles',
      },
    }, { status: 500 });
  }
}