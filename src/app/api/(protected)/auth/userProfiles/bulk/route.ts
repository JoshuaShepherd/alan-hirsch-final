// Auto-generated bulk operations route for UserProfiles
...
// import { userprofilesBulkSchema } from '@/lib/contracts';
// import { userprofilesArrayToApi, userprofilesArrayFromApi } from '@/lib/mappers';
// import type { UserProfilesSelect, UserProfilesInsert, UserProfilesUpdate, UserProfilesResponse } from '@/lib/types';
...
// POST /api/userProfiles/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk UserProfiles operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk UserProfiles operation',
      },
    }, { status: 500 });
  }
}