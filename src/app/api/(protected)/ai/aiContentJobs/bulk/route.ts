// Auto-generated bulk operations route for AiContentJobs
...
// import { aicontentjobsBulkSchema } from '@/lib/contracts';
// import { aicontentjobsArrayToApi, aicontentjobsArrayFromApi } from '@/lib/mappers';
// import type { AiContentJobsSelect, AiContentJobsInsert, AiContentJobsUpdate, AiContentJobsResponse } from '@/lib/types';
...
// POST /api/aiContentJobs/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk AiContentJobs operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk AiContentJobs operation',
      },
    }, { status: 500 });
  }
}