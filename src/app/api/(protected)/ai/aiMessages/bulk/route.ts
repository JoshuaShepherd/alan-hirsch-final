// Auto-generated bulk operations route for AiMessages
...
// import { aimessagesBulkSchema } from '@/lib/contracts';
// import { aimessagesArrayToApi, aimessagesArrayFromApi } from '@/lib/mappers';
// import type { AiMessagesSelect, AiMessagesInsert, AiMessagesUpdate, AiMessagesResponse } from '@/lib/types';
...
// POST /api/aiMessages/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk AiMessages operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk AiMessages operation',
      },
    }, { status: 500 });
  }
}