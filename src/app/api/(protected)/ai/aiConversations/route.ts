// Auto-generated collection route for AiConversations
...
// import { aiconversationsQuerySchema, aiconversationsInputSchema } from '@/lib/contracts';
// import { aiconversationsArrayToApi, aiconversationsFromApi } from '@/lib/mappers';
// import type { AiConversationsSelect, AiConversationsInsert, AiConversationsResponse } from '@/lib/types';
...
// GET /api/aiConversations - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching AiConversations list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch AiConversations list',
      },
    }, { status: 500 });
  }
}

// POST /api/aiConversations - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      data: result,
      message: 'AiConversations created successfully',
    }, { status: 201 });
  } catch (error) {
    console.error('Error creating AiConversations:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create AiConversations',
      },
    }, { status: 500 });
  }
}