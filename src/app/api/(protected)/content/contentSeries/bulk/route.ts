// Auto-generated bulk operations route for ContentSeries
...
// import { contentseriesBulkSchema } from '@/lib/contracts';
// import { contentseriesArrayToApi, contentseriesArrayFromApi } from '@/lib/mappers';
// import type { ContentSeriesSelect, ContentSeriesInsert, ContentSeriesUpdate, ContentSeriesResponse } from '@/lib/types';
...
// POST /api/contentSeries/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk ContentSeries operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk ContentSeries operation',
      },
    }, { status: 500 });
  }
}