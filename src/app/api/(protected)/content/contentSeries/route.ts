// Auto-generated collection route for ContentSeries
...
// import { contentseriesQuerySchema, contentseriesInputSchema } from '@/lib/contracts';
// import { contentseriesArrayToApi, contentseriesFromApi } from '@/lib/mappers';
// import type { ContentSeriesSelect, ContentSeriesInsert, ContentSeriesResponse } from '@/lib/types';
...
// GET /api/contentSeries - List entities with filtering, pagination, sorting
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching ContentSeries list:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to fetch ContentSeries list',
      },
    }, { status: 500 });
  }
}

// POST /api/contentSeries - Create new entity
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      data: result,
      message: 'ContentSeries created successfully',
    }, { status: 201 });
  } catch (error) {
    console.error('Error creating ContentSeries:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to create ContentSeries',
      },
    }, { status: 500 });
  }
}