// Auto-generated bulk operations route for ContentCategories
...
// import { contentcategoriesBulkSchema } from '@/lib/contracts';
// import { contentcategoriesArrayToApi, contentcategoriesArrayFromApi } from '@/lib/mappers';
// import type { ContentCategoriesSelect, ContentCategoriesInsert, ContentCategoriesUpdate, ContentCategoriesResponse } from '@/lib/types';
...
// POST /api/contentCategories/bulk - Bulk operations (create, update, delete)
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in bulk ContentCategories operation:', error);
    ...
    return NextResponse.json({
      ...
      error: {
        code: 'INTERNAL_ERROR',
        message: 'Failed to execute bulk ContentCategories operation',
      },
    }, { status: 500 });
  }
}