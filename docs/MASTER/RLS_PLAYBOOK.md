...
*Alan Hirsch Digital Platform - Current Security Policies & Access Control*
...
- `organizations` - Organization data access
...
- `subscription_plans` - Public plan information
- `user_subscriptions` - User subscription access
- `communities` - Community visibility

**⏳ PLANNED TABLES (RLS policies not yet implemented):**
- Assessment system tables
- AI conversation system tables
- Community interaction tables (posts, memberships)
