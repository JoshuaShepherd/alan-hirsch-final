...
export function createValidationError(field: string, message: string, code: string = 'invalid_type') {
  return new ApiError(
    'Validation failed',
...
export function createConflictError(resource: string, field?: string) {
  const message = field 
