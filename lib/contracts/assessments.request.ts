...
export const updateAssessmentQuestionRequestSchema =
  createAssessmentQuestionRequestSchema.partial().extend({
...
>;
export type CreateAssessmentQuestionRequest = z.infer<
  typeof createAssessmentQuestionRequestSchema
>;
export type UpdateAssessmentQuestionRequest = z.infer<
  typeof updateAssessmentQuestionRequestSchema
>;
export type StartAssessmentRequest = z.infer<
  typeof startAssessmentRequestSchema
>;
export type SaveAssessmentResponsesRequest = z.infer<
  typeof saveAssessmentResponsesRequestSchema
>;
export type CompleteAssessmentRequest = z.infer<
  typeof completeAssessmentRequestSchema
>;
export type AssessmentSearchRequest = z.infer<
  typeof assessmentSearchRequestSchema
>;
export type UserAssessmentFiltersRequest = z.infer<
  typeof userAssessmentFiltersRequestSchema
>;
